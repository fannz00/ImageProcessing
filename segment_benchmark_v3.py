...
def process_profile_postanalysis(
    ...
    """
    Process a profile for analysis, classification, and EcoTaxa export.
...
if __name__ == "__main__":
    ...
    # Configure log directories per cruise
    log_configs = {
